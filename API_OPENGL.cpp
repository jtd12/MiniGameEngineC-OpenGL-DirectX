...
void APIOPENGL:: reinitialiseGame(std::vector<object*> obj_,std::vector<prefab*> pref_,std::vector<prefabAnim*> prefAnim_)
{
	for(int i=0;i<pref.size();i++)
...
void APIOPENGL::GameMode(std::vector<object*> obj_,std::vector<prefab*> pref_,std::vector<prefabAnim*> prefAnim_)
{
...
void APIOPENGL::collision(std::vector<object*> obj_,std::vector<object*> obj2_)
{
...
void APIOPENGL::collision(std::vector<prefab*> obj_,std::vector<object*> obj2_)
{
	for(int i=0;i<obj_.size();i++)
				{
			for(int j=0;j<obj2_.size();j++)
...
void APIOPENGL::collision(std::vector<prefabAnim*> obj_,std::vector<object*> obj2_)
{
...
void APIOPENGL:: drawText(float x, float y, std::string text) {
    glRasterPos2f(x, y);
    glutBitmapString(GLUT_BITMAP_8_BY_13, (const unsigned char*)text.c_str());
}

void APIOPENGL::mode2D()
{
...
std::string APIOPENGL::vector2str(vector3d x) {
    // converts int to string
    std::stringstream ss;
    ss << x;
    return ss.str( );
}
std::string APIOPENGL::float2str(float x) {
    // converts int to string
    std::stringstream ss;
    ss << x;
    return ss.str( );
}
void APIOPENGL::enable2D(int width, int height){
...
void APIOPENGL::enable2D(int width, int height,std::vector<object*> obj_) {
...
void APIOPENGL::enable2D(int width, int height,std::vector<prefab*> obj_) {
...
void APIOPENGL::enable2D(int width, int height,std::vector<prefabAnim*> obj_) {
...
void APIOPENGL::enable2D(int width, int height,std::vector<Pobject*> obj_) {
...
void APIOPENGL::scaleObject(std::vector<object*> obj_)
{
...
void APIOPENGL::scaleObject(std::vector<Pobject*> obj_)
{
		for(int i=0;i<obj_.size();i++)
	 if(value==400 && selectObject(obj_[i]->getLocation(),p->getLocation(),vector3d(0.2,0.5,0.5),5))
	 obj_[i]->setScale(vector3d(0.1,0,0));
...
void APIOPENGL::scaleObject(std::vector<prefab*> obj_)
{
		for(int i=0;i<obj_.size();i++)
	 if(value==400 && selectObject(obj_[i]->getLocation(),p->getLocation(),vector3d(0.2,0.5,0.5),5))
	 obj_[i]->setScale(vector3d(0.1,0,0));
...
void APIOPENGL::scaleObject(std::vector<prefabAnim*> obj_)
{
		for(int i=0;i<obj_.size();i++)
	 if(value==400 && selectObject(obj_[i]->getLocation(),p->getLocation(),vector3d(0.2,0.5,0.5),5))
	 obj_[i]->setScale(vector3d(0.1,0,0));
...
void APIOPENGL::rotateObject(std::vector<object*> obj_)
{
		for(int i=0;i<obj_.size();i++)
...
void APIOPENGL::rotateObject(std::vector<Pobject*> obj_)
{
		for(int i=0;i<obj_.size();i++)
	 if(value==200 && selectObject(obj_[i]->getLocation(),p->getLocation(),vector3d(0.2,0.5,0.5),5))
	 obj_[i]->setRotation(vector3d(0.5,0,0));
...
void APIOPENGL::rotateObject(std::vector<prefab*> obj_)
{
		for(int i=0;i<obj_.size();i++)
	 if(value==200 && selectObject(obj_[i]->getLocation(),p->getLocation(),vector3d(0.2,0.5,0.5),5))
	 obj_[i]->setRotation(vector3d(0.5,0,0));
...
void APIOPENGL::rotateObject(std::vector<prefabAnim*> obj_)
{
		for(int i=0;i<obj_.size();i++)
	 if(value==200 && selectObject(obj_[i]->getLocation(),p->getLocation(),vector3d(0.2,0.5,0.5),5))
	 obj_[i]->setRotation(vector3d(0.5,0,0));
...
void APIOPENGL::colorObject(std::vector<object*> obj_)
{
		for(int i=0;i<obj_.size();i++)
...
void APIOPENGL::translateObject(std::vector<object*> obj_)
{
...
void APIOPENGL::translateObject(std::vector<Pobject*> obj_)
{
...
void APIOPENGL::translateObject(std::vector<prefab*> obj_)
{
...
void APIOPENGL::translateObject(std::vector<prefabAnim*> obj_)
{
